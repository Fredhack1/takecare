                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="revision.php">Demander revision</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link active" href="panne.php">Soumettre panne</a>
                              </li>
                              <!-- <li class="nav-item">
                     ...
                     <div class="row">
                        <?php 
                           ...
                           if (isset($_SESSION['messag'])) {
                            echo "<div><p><i class='text-warning'>" . $_SESSION['messag'] . "</i></p></div>";
                         }
                        ?>
                        <div class="label">
                           <label>
                        ...
                        <div class="col-md-12 ">
                           <select class="contactus" name="type_panne">
                             <option value="Panne Matérielle"><b style="color:#000;"><font color="black">Panne Matérielle</b></font></option>
                             <option value="Panne Logicielle"><b style="color:#000;">Panne Logicielle</b></option>
                           </select> 
                        </div>
                        <div class="col-md-12">
                           <!-- <input class="contactus" placeholder="Mot de passe" type="password" name="password">  -->
                           <textarea class="contactus" name="description" placeholder="Décrivez votre panne ici..." required></textarea>
                        </div>
                        <?php  if (isset($_SESSION['client'])) : ?>
                        <input type="hidden" name="id_client" value="<?php echo ucfirst($_SESSION['client']['id']); ?>">
                        <?php endif ?>
                        <div class="col-md-12">
                           <button class="send_btn" name="submit_panne">Envoyer</button><br>
                        </div>
                     </div>
                  </form>
               </div>

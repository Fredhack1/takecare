                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link active" href="gerer_revision.php#content">Faire révision</a>
                              </li>
                              <li class="nav-item">
                  ...
                  <div class="box_text">
                     ...
                     <table class="table table-bordered table-hover table-striped">
                        <thead>
                           <tr>
                              <th class="info">N°</th>
                              <th class="info">Type de révision</th>
                         ...
                         <tbody>
                           ...
                           <tr>
                              <td><?=$i?></td>
                              <td><?=$row['type_revision']?></td>
                              <td><?=$row['intitule']?></td>
                              <td><?=$ligne['pseudo']?></td>
                              <td><?=$row['date_revision']?></td>
                              <td align="center">
                                 <form method="POST" action="code.php">
                                    <input type="hidden" name="id_faire_rev" value="<?=$row['id_revision']?>">
                                    <a href="intervenir_revision.php?client=<?=$ligne['pseudo']?>">
                                       <b class="text-dark"> INTERVENIR</b>
                                    </a>
                                    <button type="submit" name="faire_rev" style="border: none; background: none;" class="btn btn-default">

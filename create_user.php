            ...
            <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                        <h4>Créer un utilisateur 
                            <a href="list_user.php" style="float: right;" class="btn btn-danger">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="func_admin_register.php" class="container">
                        <?php 
                           // include 'func_admin_register.php';
                           if (isset($_SESSION['msg'])) {
                              echo "<b class='text-danger'>" . $_SESSION['msg'] . "</b>";
                           }
                        ?>
                        ...
                        <div class="form-group">
                           <label for="type_user"><b>Type d'utilisateur</b></label>
                        ...
                        <div class="form-group">
                        <button  type="submit" class="btn btn-success btn-lg" name= "register_btn">submit</button>
                        </div>
                     </form>
                    </div>
                </div>

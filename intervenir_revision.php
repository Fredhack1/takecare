            ...
            <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                        <h4>PRISE DE CONTROLE A DISTANCE 
                            <a href="gerer_revision.php#content" style="float: right;" class="btn btn-danger">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <center>
                           <h3><b>Prise de contrôle mis en perspective</b></h3>
                        </center>
                    </div>
                </div>
            </div>
